...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/adhesionstyle.css">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12 col-xl-8 ">
            <img src="../../public/assets/img/handicap.jpg" class="imgStats" alt="Personne souriant à la vie en fauteil roulant">
        </div>
...
?>
<script src="../../public/assets/js/adhesion.js"></script>
</body>
</html>