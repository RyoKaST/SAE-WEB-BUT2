...
if (isset($_SESSION['user'])) {
    ...
    <a href="../components/Deconnexion.php" class="btn">Se déconnecter</a>
</div>
<?php
} else {
    ?>
    <div id="auth">
        <div class="auth-container">
            ...
            <div class="tab-content" id="signin">
                <form method="post" action="../auth/signin.php" class="form">
                    <h2>Connexion</h2>
            ...
            <div class="tab-content hidden" id="signup">
                <form method="post" action="../auth/signup.php" class="form">
                    <h2>Inscription</h2>
                    <div class="form-group">
