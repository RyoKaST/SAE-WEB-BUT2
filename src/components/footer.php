...
<footer class="footer">
    ...
    <div class="social-media">
        <a href="https://www.facebook.com/AMinathandi?locale=fr_FR"><img src="../../public/assets/img/facebook-icon.png"
                                                                         alt="Facebook"></a>
        <a href="https://x.com/ami_nationale"><img src="../../public/assets/img/X-icon.png"" alt="Twitter"></a>
    </div>
</footer>
